...
public class PrimoCarne extends Primo implements Serializable
{
	...
	public PrimoCarne(IDEsterno t, Orologio dataCreazione)
	{
		super(t);
		this.dataCreazione = dataCreazione;
	}
	
	public  PrimoCarne(IDEsterno t, Orologio dataCreazione, double pA, double pV) // Usata Per Creazioni prodotto con Prezzo A/V
	{
		super(t);
		this.dataCreazione = dataCreazione;
	...
	public PrimoCarne() //Usato per creare un semplice oggetto che calcola indici
	{
		super();
	}
	...
	{
		if (!new File("Save/PrimoCarne.dat").exists()) 
		{
			//return false;
			throw new DeserializzazioneException("File PrimoCarne ancora non disponibile!");
		}
				
		DeserializzaOggetti load = new DeserializzaOggetti("Save/PrimoCarne.dat");
		try 
		{
	...
	public static void salvaVarStatiche() throws SerializzazioneException 
	{
		...
		String Dir = "Save";
		new File(Dir).mkdir();
		String path = Dir+"/PrimoCarne.dat";
