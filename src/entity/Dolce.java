...
public class Dolce extends Portata implements Serializable
{	
	//Variabili di classe
	...
	/*public Dolce(IDEsterno t)
	{
		super(t);
	}*/
	
	public Dolce(IDEsterno t, Orologio dataCreazione)
	{
		super(t);
		this.dataCreazione = dataCreazione;
	}
	
	public  Dolce(IDEsterno t, Orologio dataCreazione, double pA, double pV) // Usata Per Creazioni prodotto con Prezzo A/V
	{
		super(t);
		this.dataCreazione = dataCreazione;
	...
	public Dolce() //Usato per creare un semplice oggetto che calcola indici
	{
		super();
	}
	...
	{
		if (!new File("Save/Dolce.dat").exists()) 
		{
			//return false;
			throw new DeserializzazioneException("File Dolce ancora non disponibile!");
		}
				
		DeserializzaOggetti load = new DeserializzaOggetti("Save/Dolce.dat");
		try 
		{
