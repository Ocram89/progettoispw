...
public class Soda extends Bevanda implements Serializable
{	
	//Variabili di classe
	...
	public Soda(IDEsterno t, Orologio dataCreazione)
	{
		super(t);
	...
	public Soda(IDEsterno t, Orologio dataCreazione, double pA, double pV) // Usata Per Creazioni prodotto con Prezzo A/V
	{
		super(t);
		this.dataCreazione = dataCreazione;
	...
	public Soda() //Usato per creare un semplice oggetto che calcola indici
	{
		super();
	}
	...
	{
		if (!new File("Save/Soda.dat").exists()) 
		{
			//return false;
			throw new DeserializzazioneException("File varStatiche ancora non disponibile!");
		}
				
		DeserializzaOggetti load = new DeserializzaOggetti("Save/Soda.dat");
		try 
		{
	...
	{
		System.out.println("Calcolo successoClasse Soda...");
	...
	{
		System.out.println("Calcolo gradimento Soda...");
	...
	{
		System.out.println("Calcolo gradimentoClasse Soda...");
	...
	{
		System.out.println("Calcolo deperibilità Soda...");
	...
	{
		System.out.println("Calcolo deperibilitàClasse Soda...");
