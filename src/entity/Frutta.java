...
public class Frutta extends Portata implements Serializable
{	
	//Variabili di classe
	...
	/*public Frutta(IDEsterno t)
	{
		super(t);
	}*/
	
	public Frutta(IDEsterno t, Orologio dataCreazione)
	{
		super(t);
		this.dataCreazione = dataCreazione;
	}
	
	public  Frutta(IDEsterno t, Orologio dataCreazione, double pA, double pV) // Usata Per Creazioni prodotto con Prezzo A/V
	{
		super(t);
		this.dataCreazione = dataCreazione;
	...
	public Frutta() //Usato per creare un semplice oggetto che calcola indici
	{
		super();
	}
	...
	{
		if (!new File("Save/Frutta.dat").exists()) 
		{
			//return false;
			throw new DeserializzazioneException("File Frutta ancora non disponibile!");
		}
				
		DeserializzaOggetti load = new DeserializzaOggetti("Save/Frutta.dat");
		try 
		{
	...
	{
		//System.out.println("Calcolo gradimento "+ this.getClass().getName()+"...");
	...
	{
		String s = "\nClasse Frutta:\n" +
    			"tDepositati: "+tDepositati+"\n"+
    			"tErogati: "+tErogati+"\n"+
    			"tRichiesti: "+tRichiesti+"\n"+
    			"tScaduti: "+tScaduti+"\n";
		return s;
	}
	...
	//METODO (b) Calcolo Indici Gerarchia classi Dominio
		...
		public double gradimento(IDEsterno c) throws ArithmeticException
		{
			...
			else if(c.toString().equals(this.getClass().getName()))
			{
				...
				if (tPortateErogate > 0) return (double) tErogati/(double) tPortateErogate;
				
		        throw new ArithmeticException ("Al momento nessun/a " + this.getClass().getName() + " di questo tipo risulta ancora erogato/a. Impossibile calcolarne indice di gradimento!");
			}
			else 
			{	System.out.println("E' una Portata");
