...
public class Altro extends Bevanda implements Serializable
{	
	//Variabili di classe
	...
	public Altro(IDEsterno t, Orologio dataCreazione)
	{
		super(t);
	...
	public Altro(IDEsterno t, Orologio dataCreazione, double pA, double pV) // Usata Per Creazioni prodotto con Prezzo A/V
	{
		super(t);
		this.dataCreazione = dataCreazione;
	...
	public Altro() //Usato per creare un semplice oggetto che calcola indici
	{
		super();
	}
	...
	{
		if (!new File("Save/Altro.dat").exists()) 
		{
			//return false;
			throw new DeserializzazioneException("File Altro ancora non disponibile!");
		}
				
		DeserializzaOggetti load = new DeserializzaOggetti("Save/Altro.dat");
		try 
		{
	...
	{
		System.out.println("Successo Altro");
	...
	{
		System.out.println("Calcolo successoClasse Altro...");
	...
	{
		System.out.println("Calcolo gradimento Altro...");
	...
	{
		System.out.println("Calcolo gradimentoClasse Altro...");
	...
	{
		System.out.println("Calcolo deperibilità Altro...");
	...
	//METODO (b) Calcolo Indici Gerarchia classi Dominio
			public double successo(IDEsterno c) throws ArithmeticException
			{
				...
				{	System.out.println("E' una Bevanda o una Portata");
					return super.successo(c); //Se "c" non è ne un prodotto e ne ClasseBase, vai al metodo superiore
				}
			}
			...
			public double deperibilita(IDEsterno c) throws ArithmeticException
			{
				...
				{
					System.out.println("Calcolo deperibilitàClasse Altro...");
