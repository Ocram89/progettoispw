...
public class SecondoPesce extends Secondo implements Serializable
{	
	...
	public SecondoPesce(IDEsterno t, Orologio dataCreazione)
	{
		super(t);
		this.dataCreazione = dataCreazione;
	}
	
	public  SecondoPesce(IDEsterno t, Orologio dataCreazione, double pA, double pV) // Usata Per Creazioni prodotto con Prezzo A/V
	{
		super(t);
		this.dataCreazione = dataCreazione;
	...
	public SecondoPesce() //Usato per creare un semplice oggetto che calcola indici
	{
		super();
	}
	...
	{
		if (!new File("Save/SecondoPesce.dat").exists()) 
		{
			//return false;
			throw new DeserializzazioneException("File SecondoPesce ancora non disponibile!");
		}
				
		DeserializzaOggetti load = new DeserializzaOggetti("Save/SecondoPesce.dat");
		try 
		{
	...
	public static void salvaVarStatiche() throws SerializzazioneException 
	{
		...
		String Dir = "Save";
		new File(Dir).mkdir();
		String path = Dir+"/SecondoPesce.dat";
