...
public class PrimoPesce extends Primo implements Serializable
{
	...
	public PrimoPesce(IDEsterno t, Orologio dataCreazione)
	{
		super(t);
		this.dataCreazione = dataCreazione;
	}
	
	public  PrimoPesce(IDEsterno t, Orologio dataCreazione, double pA, double pV) // Usata Per Creazioni prodotto con Prezzo A/V
	{
		super(t);
		this.dataCreazione = dataCreazione;
	...
	public PrimoPesce() //Usato per creare un semplice oggetto che calcola indici
	{
		super();
	}
	...
	{
		if (!new File("Save/PrimoPesce.dat").exists()) 
		{
			//return false;
			throw new DeserializzazioneException("File PrimoPesce ancora non disponibile!");
		}
				
		DeserializzaOggetti load = new DeserializzaOggetti("Save/PrimoPesce.dat");
		try 
		{
	...
	public static void salvaVarStatiche() throws SerializzazioneException 
	{
		...
		String Dir = "Save";
		new File(Dir).mkdir();
		String path = Dir+"/PrimoPesce.dat";
